...
cities = {
    'москва': ['1030494/a285ad78c7ad5b98abc5', '997614/b7850a47f53d8c39e514'],
    'нью-йорк': ['1030494/9612752b5140e4fc460c', '1521359/d01e8c49a99f1e901449'],
    'париж': ["1030494/cb0a23002767bfe12937", '1652229/e843e6bf4d93fd985b78']
}
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if not sessionStorage[user_id]['game_started']:
            ...
            if 'да' in req['request']['nlu']['tokens']:
                ...
                res['response']['text'] = 'Это игра в города. Я показываю вам картинку города, а вы должны ее угадать. Начнём игру?'
            else:
...
def play_game(res, req):
    ...
    if attempt == 1:
        ...
        if get_city(req) == city:
            ...
            res['response']['text'] = 'Это игра в города. Я показываю вам картинку города, а вы должны ее угадать. Продолжим?'
